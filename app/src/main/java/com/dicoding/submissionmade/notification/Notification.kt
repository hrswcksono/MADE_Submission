...
class Notification : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val channelName = "Github App"

        val notificationManagerCompat = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        val alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
        val backApp = Intent(context, MainActivity::class.java)
        val backAppNotification = PendingIntent.getActivities(context, ID_REPEATING, arrayOf(backApp), 0)
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setSound(alarmSound)
            .setContentIntent(backAppNotification)
            .setAutoCancel(true)
